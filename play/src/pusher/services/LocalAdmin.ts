...
class LocalAdmin implements AdminInterface {
    ...
    fetchMapDetails(
        ...
        return Promise.resolve({
            ...
            loadingLogo: "/static/images/nomad-workmates-logo.png",
            loginSceneLogo: "/static/images/nomad-workmates-logo.png",
            errorSceneLogo: "/static/images/nomad-workmates-logo.png",
            showPoweredBy: true,
